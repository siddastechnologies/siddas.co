        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl font-headline">
              Our DevOps Transformation <span className="gradient-text">Process</span>
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
              We follow a structured, four-phase process to ensure your DevOps transformation is smooth, effective, and delivers measurable results.
            </p>
          </div>
      ...
      <section className="w-full py-20 md:py-24 bg-card">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              We are experts in the tools that power modern CI/CD and automation.
            </p>
          </div>
