...
export const PRODUCTS: Product[] = [
    {
        ...
        icon: Users,
        details: 'Our Human Resource Management System (HRMS) automates and simplifies HR processes. It covers employee data management, payroll, attendance, performance appraisal, and more, all in one integrated platform.',
    ...
    },
    {
        ...
        icon: Library,
        details: 'Digitize your library with our comprehensive management system. It handles cataloging, circulation, member management, and reporting, making it ideal for schools, universities, and public libraries.',
    ...
    },
    {
        ...
        icon: BookOpen,
        details: 'Our Learning Management System (LMS) is designed for educational institutions and corporate training. It supports online course creation, student enrollment, assessments, and progress tracking, providing a seamless e-learning experience.',
